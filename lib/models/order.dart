...
class Order {
  ...
  factory Order.fromJson(Map<String, dynamic> json) {
    ...
    // NOUVEAU: Parse follow_up_at
    DateTime? parsedFollowUpAt;
    final followUpAtString = json['follow_up_at'] as String?;
    if (followUpAtString != null) {
        try {
            parsedFollowUpAt = DateTime.parse(followUpAtString);
        } catch (e) {
             if (kDebugMode) {
                print("Erreur parsing Order follow_up_at: $e, Data: $followUpAtString");
            }
        }
    }
    ...
    return Order(
      ...
      followUpAt: parsedFollowUpAt, // <- AJOUTÉ
    );
    // **********************************
  }
