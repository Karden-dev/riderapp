// lib/screens/riders_returns_screen.dart
...
class _OrdersReturnsScreenState extends State<OrdersReturnsScreen> {
  ...
  void _setInitialDatesAndFetch() {
    ...
    // Défaut: 30 derniers jours pour les retours (comme dans la PWA rider.js)
    ...
    if (mounted) {
      setState(() {
        _ordersFuture = orderService.fetchRiderOrders(
          // Statuts pour les retours (inchangé)
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                   ...
                   // onChanged: (_) => _applyFilters(), // Optionnel
                ),
                ...
                return RefreshIndicator( // Ajout du RefreshIndicator
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      // Réutilise OrderCard. La bordure rouge sera appliquée par la logique interne de OrderCard.
