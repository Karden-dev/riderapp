...
import '../services/sync_service.dart'; // Correction du chemin pour la cohérence
...
class OrderService {
  ...
  final statusTranslations = {
    ...
    'reported': 'Signalée', // Renommé pour correspondre au sens général
  ...
  Future<void> updateOrderStatus({
    ...
    // AJOUT DE LA DATE DE SUIVI si fournie
    if (scheduledAt != null) {
      // Clé DB: follow_up_at
      payload['follow_up_at'] = scheduledAt.toIso8601String();
    }
