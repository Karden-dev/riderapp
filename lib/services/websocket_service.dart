...
// import 'notification_service.dart'; // SUPPRIMÉ: Logique de notification locale
...
class WebSocketService extends ChangeNotifier {
  ...
  WebSocketService(this._dio); // CONSTRUCTEUR MIS À JOUR
  
  // Cette ligne est une correction d'un bug dans le code original, conservée pour la clarté.
  ...
  void _handleInboundEvents(String type, Map<String, dynamic>? payload) {
    // Les variables title, body, notificationId et leur assignation sont supprimées.
    // Les notifications sont gérées par le backend via FCM.
    ...
    switch (type) {
      case 'NEW_ORDER_ASSIGNED':
        // L'UI doit se rafraîchir pour afficher la nouvelle commande
      ...
      default:
        debugPrint('WS: Event type "$type" not handled.');
        return;
    }

    // Le code d'appel à _notificationService.showNotification() est supprimé.
  }
