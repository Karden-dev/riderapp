...
// import 'notification_service.dart'; // SUPPRIMÉ: Remplacé par FCM
...
class SyncService extends ChangeNotifier {
  ...
  SyncService(this._dio); // Constructeur mis à jour (1 argument)
  ...
  Future<void> _replayFailedRequests() async {
    ...
    if (successCount > 0) {
      ...
      // NOTE: Notification locale supprimée (remplacée par FCM)
      // L'appel à _notificationService.showNotification(...) a été retiré.
